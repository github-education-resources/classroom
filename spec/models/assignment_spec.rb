...
RSpec.describe Assignment, type: :model do
  ...
  describe "#starter_code_repository_not_empty" do
    ...
    it "raises an error when starter code repository is empty", :vcr do
      ...
      expect { assignment.save! }.to raise_error(GitHub::Error, "Starter code repository cannot be empty. Select a "\
        "repository that is not empty or create the assignment without starter code.")
    end
