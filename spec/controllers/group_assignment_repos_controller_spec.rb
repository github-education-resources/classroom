...
RSpec.describe GroupAssignmentReposController, type: :controller do
  ...
  describe 'GET #latest_release', :vcr do
    before(:each) do
    ...
    context 'unauthenticated request' do
      ...
      it 'redirects to the login page' do
        get :latest_release, organization_id: organization.slug,
    ...
    context 'user with admin privilege on the organization' do
      ...
      context 'valid parameters' do
        ...
        it 'renders correct template' do
          expect(response).to render_template(partial: 'shared/github_repository/_latest_release')
        end
      end
