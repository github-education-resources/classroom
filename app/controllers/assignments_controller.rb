...
class AssignmentsController < ApplicationController
  ...
  def new_assignment_params
    params
      .require(:assignment)
      .permit(:title, :slug, :public_repo, :students_are_repo_admins, :invitations_are_enabled)
  ...
  def update_assignment_params
    params
      .require(:assignment)
      .permit(:title, :slug, :public_repo, :students_are_repo_admins, :deadline, :invitations_are_enabled)
